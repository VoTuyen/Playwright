// Import AJV
import Ajv from 'ajv';
import { benefit_schema, check_transaction_schema, package_screen_schema, customer_info_schema } from '../schemas/index.js';
...
ajv.addSchema(customer_info_schema, 'customer_info_schema'); // Đăng ký customer_info_schema
